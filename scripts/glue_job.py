...
confirmedDf=readCSV(spark, "s3://covidanalysis/covid19/confirmed/time_series_covid19_confirmed_global.csv")
deathDf=readCSV(spark,"s3a://covidanalysis/covid19/deaths/time_series_covid19_deaths_global.csv")
recoveredDf=readCSV(spark,"s3a://covidanalysis/covid19/recovered/time_series_covid19_recovered_global.csv")

outputPath = "s3a://covidanalysis/covid19/processedData"
